...
class Forum
{
    ...
    public function comment(int $answerId, string $body)
    {
        ...
        $answer = $this->answers[$answerId]; // 1 moqt_e_php_storm
        ...
        $this->currentUser->comment($answer, $comment);
    }
        ...
        foreach ($this->questions as $question) {
            ...
            foreach ($question->getAnswers() as $answer) {
                ...
                foreach ($answer->getComments() as $comment) {
                    echo "           --- Comment Body: " . $comment->getBody() . " Author: " . $comment->getAuthor()->getUsername() . PHP_EOL;
                }
            }
        }
    }
